...
#include "RunnerBlock_RightTurn.h"
#include "Components/StaticMeshComponent.h"
#include "Components/ArrowComponent.h"
#include "Components/BoxComponent.h"

ARunnerBlock_RightTurn::ARunnerBlock_RightTurn() {
	...
	Arrow->SetRelativeLocation(FVector(384, 384, 0));
	Arrow->SetRelativeRotation(FRotator(0, 90, 0));

	spawnTrigger->SetBoxExtent(FVector(128, 20, 128));
	spawnTrigger->SetRelativeLocation(FVector(384, 384, 64));
